...
this.attackPings = [];
    ...
    this._decorRenderBucketMap = new Map();
    this.decorRenderBuckets = null;
    this.decorRenderBucketSize = 256;
    this.decorRenderVersion = -1;
    this._skyDecor = [];
    this._nearbyBuf = [];
    this._nearbyResBuf = [];
    this._nearbyBldBuf = [];
    ...
    this._drawables = [];
    this._decorQueryBuf = [];
    this._resourceRenderBuf = [];
    this._buildingRenderBuf = [];
    this._unitRenderBuf = [];
    this._spatialTimer = 0;
    this._shouldRebuildSpatial = true;
    this._terrainChunkCache = new Map();
    this._terrainChunkOrder = [];
    this._terrainChunkKey = '';
    this._minimapEntityCanvas = null;
    this._minimapEntityKey = '';
    this._minimapEntityTime = -999;
    ...
    this._pathRows = 0;
    this._pathCame = null;
    this._pathGScore = null;
    this._pathClosed = null;
